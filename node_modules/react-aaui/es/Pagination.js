...
var Pagination = function Pagination(_ref) {
  ...
  var classes = classnames((_classnames = {}, _defineProperty(_classnames, type, true), _defineProperty(_classnames, 'pagination--' + theme, type === 'pagination' && theme), _classnames), className);

  return total > 1 && React.createElement(
    'ul',
