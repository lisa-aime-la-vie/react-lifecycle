...
var TagEditor = function (_PureComponent) {
  ...
  function TagEditor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TagEditor.__proto__ || _Object$getPrototypeOf(TagEditor)).call.apply(_ref, [this].concat(args))), _this), _this.setTagRef = function (tag) {
      _this.tag = tag;
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        data.map(function (_ref2, i) {
          var text = _ref2.text,
              isNew = _ref2.isNew,
              tagRestProps = _objectWithoutProperties(_ref2, ['text', 'isNew']);
