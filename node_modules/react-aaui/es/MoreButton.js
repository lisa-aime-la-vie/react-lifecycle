...
var MoreButton = function (_PureComponent) {
  ...
  function MoreButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MoreButton.__proto__ || _Object$getPrototypeOf(MoreButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (_ref2) {
      var v = _ref2.value;
