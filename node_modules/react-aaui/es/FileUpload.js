...
var FileUpload = function (_PureComponent) {
  ...
  function FileUpload(prop) {
    ...
    var _this = _possibleConstructorReturn(this, (FileUpload.__proto__ || _Object$getPrototypeOf(FileUpload)).call(this, prop));

    _this.onChange = function (e) {
      e.preventDefault();

      var _ref = e.dataTransfer || e.target || {},
          files = _ref.files;
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      ...
      var labelClasses = classNames(_defineProperty({
        btn: true
      }, 'btn-' + size, size), className);
