...
var Tag = function (_PureComponent) {
  ...
  function Tag(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Tag.__proto__ || _Object$getPrototypeOf(Tag)).call(this, props));
  ...
  _createClass(Tag, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'span',
        _extends({ className: classes }, omit(rest, ['onChange', 'onCancel']), { tabIndex: 0 }),
        isInput ? React.createElement('input', {
          ...
          onBlur: this.handleBlur }) : React.createElement(
          'span',
