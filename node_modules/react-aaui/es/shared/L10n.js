...
import getDateTimeSymbols from '../form/config/getDateTimeSymbols';
...
export var defaultValidationMsgKeys = {
  ...
  maxDate: 'react-aaui.validation.date.maxDate',
  minDate: 'react-aaui.validation.date.minDate'
};
...
var L10n = function () {
  function L10n() {
    ...
    this._config = _extends({
      dateTimeSymbol: getDateTimeSymbols(locale),
  ...
  _createClass(L10n, [{
    ...
    key: 'parseDateTime',
    value: function parseDateTime(value, format) {
    ...
    set: function set(value) {
      this._locale = value;
      this._config.dateTimeSymbol = getDateTimeSymbols(this._locale);
