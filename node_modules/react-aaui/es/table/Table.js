...
import { bool, string, array, func, object, node, oneOfType, oneOf } from 'prop-types';
...
var Table = function (_PureComponent) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Table.__proto__ || _Object$getPrototypeOf(Table)).call.apply(_ref, [this].concat(args))), _this), _this.handleHeadSelect = function () {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          additionalHeader = _props3.additionalHeader;


      var tableClasses = classNames('table', 'table--fixed', _defineProperty({}, 'table--' + textOverflow, textOverflow), className);
