...
var TablePagination = function (_PureComponent) {
  ...
  function TablePagination() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TablePagination.__proto__ || _Object$getPrototypeOf(TablePagination)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (currentPage) {
      return function (e) {
        e.preventDefault();
