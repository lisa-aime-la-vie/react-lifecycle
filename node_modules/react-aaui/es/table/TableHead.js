...
var TableHead = function (_PureComponent) {
  ...
  function TableHead() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TableHead.__proto__ || _Object$getPrototypeOf(TableHead)).call.apply(_ref, [this].concat(args))), _this), _this.handleSort = function (colName) {
      return function () {
