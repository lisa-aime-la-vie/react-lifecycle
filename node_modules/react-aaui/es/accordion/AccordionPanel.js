...
var AccordionPanel = function (_React$PureComponent) {
  _inherits(AccordionPanel, _React$PureComponent);
  ...
  function AccordionPanel() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AccordionPanel.__proto__ || _Object$getPrototypeOf(AccordionPanel)).call.apply(_ref, [this].concat(args))), _this), _this.setAccordionBodyContainer = function (container) {
      ...
      if (_this.props.active) {
        if (_this._container && _this._container.style) {
