...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentWillReceiveProps = function (nextProps) {
    ...
    if (_Object$keys(newState).length > 0) {
      var _value = newState.value || nextProps.value || nextProps.defaultValue;
      newState.activeItemIndex = nextProps.highlight ? _this2.getActiveIndex(nextProps.data, _value) : -1;
  ...
  this.componentDidUpdate = function (prevProps, prevState) {
    ...
    if (_this2.state.isExpanded) {
      if (_this2.props.filter) {
        _this2.filterInput && _this2.filterInput.focus();
      } else {
        _this2.itemMenu && _this2.itemMenu.focus();
      }

      var itemMenu = _this2.itemMenu;

      var activeItem = itemMenu && itemMenu.querySelector('.selected');
      if (activeItem && itemMenu) {
  ...
  this.getIndex = function (str) {
    var dataArray = _this2.props.data;
    var index = 0;
    var value = '';
      ...
      case KEY_CODES.ENTER:
        // enter (Select the active item)
        {
          var _state = _this2.state,
              _dataView = _state.dataView,
              _activeItemIndex = _state.activeItemIndex;


          if (_activeItemIndex !== -1) {
            var _value2 = da.get(_dataView, _activeItemIndex);
            _value2 = da.get(_value2, 'value');
            _this2.select(_value2);
            _this2.dropdownButton && _this2.dropdownButton.focus();
          }
        }
        break;
  ...
  this.findItemByValue = function (value) {
    ...
    try {
      for (var _iterator = _getIterator(_this2.props.data), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  this.filterData = function (key, dataset) {
    ...
    function matcher(item) {
      ...
      try {
        for (var _iterator2 = _getIterator(t), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var tc = _step2.value;
  ...
  this.render = function () {
    ...
    var _props2 = _this2.props,
        ...
        style = _props2.style,
        name = _props2.name,
        rest = _objectWithoutProperties(_props2, ['className', 'maxHeight', 'placeholder', 'filterPlaceholder', 'size', 'theme', 'preIcon', 'disabled', 'filter', 'isMoreButton', 'style', 'name']);
    ...
    }, _defineProperty(_classNames, 'dropdown--' + theme, theme), _defineProperty(_classNames, 'dropdown--' + size, size), _classNames), className);
          ...
          dataView.map(function (item, i) {
            return React.createElement(
              'li',
              {
                ...
                tabIndex: 0,
                role: 'option',
                className: classNames({ selected: i === activeItemIndex }, da.get(item, 'className')),
