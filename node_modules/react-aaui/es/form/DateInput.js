...
var DateInput = function (_PureComponent) {
  ...
  function DateInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = DateInput.__proto__ || _Object$getPrototypeOf(DateInput)).call.apply(_ref2, [this].concat(args))), _this), _this.handleBlur = function (e) {
...
export var validator = function validator(_ref3) {
  var l10n = _ref3.l10n,
  ...
  return function (validationResult) {
    ...
    if (maxDate && dateReg.test(maxDate) && new Date(value) > new Date(maxDate)) {
      return new ValidationResult(name, value, l10n.formatMessage(l10n.maxDate, { maxDate: maxDate }));
    }

    if (minDate && dateReg.test(minDate) && new Date(value) < new Date(minDate)) {
      return new ValidationResult(name, value, l10n.formatMessage(l10n.minDate, { minDate: minDate }));
    }
