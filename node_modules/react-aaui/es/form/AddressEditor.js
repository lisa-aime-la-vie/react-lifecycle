...
import Form from './index'; // eslint-disable-line import/no-cycle
...
var AddressEditor = function (_PureComponent) {
  ...
  function AddressEditor(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (AddressEditor.__proto__ || _Object$getPrototypeOf(AddressEditor)).call(this, props, context));
    ...
    _this.reduceFields = function (country) {
      ...
      return _Object$keys(countryAddressFields).reduce(function (r, k) {
        ...
        return _extends({}, r, _defineProperty({}, addressPart, finalField));
      }, { country: country });
    };
    ...
    _this.reduceCountryAddressFields = function (country) {
      ...
      return _Object$keys(countryAddressFields).reduce(function (r, k) {
        ...
        return [].concat(_toConsumableArray(r), [reducedAddressField]);
      }, []);
    };
    ...
    _this.handlePreChange = function (values) {
      ...
      return _Object$keys(countryAddressFields).reduce(function (r, k) {
        ...
        return _extends({}, r, _defineProperty({}, addressPart, _extends({}, addressPartValue, {
  ...
  _createClass(AddressEditor, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['fieldLayout', 'isSimpleAddress', 'fieldsConfig', 'addressEditorTitles', 'addressEditorIds']);
...
AddressEditor.propTypes = _extends({
  ...
  fieldsConfig: object, // eslint-disable-line

  fieldLayout: oneOfType([node, func]),
  addressEditorTitles: object,
  addressEditorIds: object
