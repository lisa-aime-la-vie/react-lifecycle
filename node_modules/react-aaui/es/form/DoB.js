...
var DoB = function (_Component) {
  ...
  function DoB(props) {
    ...
    var _this = _possibleConstructorReturn(this, (DoB.__proto__ || _Object$getPrototypeOf(DoB)).call(this, props));
  ...
  this.handleChange = function (name) {
    return function (_ref2) {
      ...
      var newState = _extends({}, _this3.state, {
        values: _extends({}, _this3.state.values, _defineProperty({}, name, parseInt(value, 10)))
      });
