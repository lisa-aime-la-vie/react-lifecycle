...
var Select = function (_PureComponent) {
  ...
  function Select() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Select.__proto__ || _Object$getPrototypeOf(Select)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (_ref2) {
