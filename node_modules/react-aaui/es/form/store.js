...
var Store = function () {
  ...
  _createClass(Store, [{
    ...
    value: function injectValidator(key, validator) {
      ...
      this.validators = _extends({}, this.validators, _defineProperty({}, key, validator));
    ...
    value: function tryInvokeValidators() {
      ...
      return validatorKeys.reduce(function (r, k) {
        ...
        return [].concat(_toConsumableArray(r), [validationResult]);
      }, []);
    }
  }, {
    key: 'injectReducer',
    value: function injectReducer(key, reducer) {
      ...
      this.asyncReducers = _extends({}, this.asyncReducers, _defineProperty({}, key, reducer));
    ...
    key: 'dispatch',
    value: function dispatch(action, suppressNotify) {
      var _this5 = this;
