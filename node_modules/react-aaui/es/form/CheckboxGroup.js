...
var FormCheckboxGroup = function (_PureComponent) {
  ...
  function FormCheckboxGroup() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormCheckboxGroup.__proto__ || _Object$getPrototypeOf(FormCheckboxGroup)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (value) {
  ...
  _createClass(FormCheckboxGroup, [{
    key: 'render',
