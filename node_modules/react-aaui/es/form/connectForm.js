  ...
  return function (WrappedComponent) {
    var Connect = function (_PureComponent) {
      ...
      function Connect(props, context) {
        ...
        var _this = _possibleConstructorReturn(this, (Connect.__proto__ || _Object$getPrototypeOf(Connect)).call(this, props, context));
        ...
        _this.validate = function (value) {
          ...
          var _reduceReducers = reduceReducers.apply(undefined, _toConsumableArray(chain))(new ValidationResult(name, parser(value, { l10n: l10n }), null)),
      ...
      _createClass(Connect, [{
        ...
        value: function render() {
          ...
          var omitArr = ['validator', 'parser'];
          if (!wrappedComponentProps.betterWCAGSupport) {
            // default
            omitArr.push('required');
          }

          this.renderedElement = createElement(WrappedComponent, omit(wrappedComponentProps, omitArr));
