...
export default function confirm(options) {
  ...
  function modalConfirm(_ref) {
    var shown = _ref.shown,
        ...
        rest = _objectWithoutProperties(_ref, ['shown', 'suppressOk', 'suppressCancel', 'close', 'handleCancel', 'handleOk', 'title', 'content', 'cancelText', 'okText', 'processing']);
  ...
  function render(props) {
    ReactDOM.render(modalConfirm(omit(props, ['onCancel', 'onOk', 'parent'])), div);
  }
