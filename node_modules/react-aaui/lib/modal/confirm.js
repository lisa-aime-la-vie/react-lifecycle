...
function confirm(options) {
  ...
  function modalConfirm(_ref) {
    var shown = _ref.shown,
        ...
        rest = (0, _objectWithoutProperties3.default)(_ref, ['shown', 'suppressOk', 'suppressCancel', 'close', 'handleCancel', 'handleOk', 'title', 'content', 'cancelText', 'okText', 'processing']);
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        suppressOk || _react2.default.createElement(
          _Button2.default,
          { type: 'primary', onClick: handleOk, loading: processing },
          okText
        )
      )
    );
  ...
  function render(props) {
    _reactDom2.default.render(modalConfirm((0, _utils.omit)(props, ['onCancel', 'onOk', 'parent'])), div);
  }
