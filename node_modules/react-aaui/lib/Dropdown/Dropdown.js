...
var _initialiseProps = function _initialiseProps() {
  ...
  this.findItemByValue = function (value) {
    ...
    try {
      for (var _iterator = (0, _getIterator3.default)(_this2.props.data), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  this.render = function () {
    ...
    var _props2 = _this2.props,
        ...
        style = _props2.style,
        name = _props2.name,
        rest = (0, _objectWithoutProperties3.default)(_props2, ['className', 'maxHeight', 'placeholder', 'filterPlaceholder', 'size', 'theme', 'preIcon', 'disabled', 'filter', 'isMoreButton', 'style', 'name']);
    ...
    }, (0, _defineProperty3.default)(_classNames, 'dropdown--' + theme, theme), (0, _defineProperty3.default)(_classNames, 'dropdown--' + size, size), _classNames), className);
          ...
          dataView.map(function (item, i) {
            return _react2.default.createElement(
              'li',
              {
                ...
                tabIndex: 0,
                role: 'option',
                className: (0, _classnames2.default)({ selected: i === activeItemIndex }, da.get(item, 'className')),
