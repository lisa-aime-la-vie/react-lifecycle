...
var Table = function (_PureComponent) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Table.__proto__ || (0, _getPrototypeOf2.default)(Table)).call.apply(_ref, [this].concat(args))), _this), _this.handleHeadSelect = function () {
  ...
  (0, _createClass3.default)(Table, [{
    ...
    value: function render() {
      ...
      var tableClasses = (0, _classnames2.default)('table', 'table--fixed', (0, _defineProperty3.default)({}, 'table--' + textOverflow, textOverflow), className);
...
Table.propTypes = {
  ...
  additionalHeader: _propTypes.node,
