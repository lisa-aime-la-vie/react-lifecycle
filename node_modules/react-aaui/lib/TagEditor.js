...
var TagEditor = function (_PureComponent) {
  ...
  function TagEditor() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = TagEditor.__proto__ || (0, _getPrototypeOf2.default)(TagEditor)).call.apply(_ref, [this].concat(args))), _this), _this.setTagRef = function (tag) {
      _this.tag = tag;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        data.map(function (_ref2, i) {
          var text = _ref2.text,
              isNew = _ref2.isNew,
              tagRestProps = (0, _objectWithoutProperties3.default)(_ref2, ['text', 'isNew']);
