...
var MoreButton = function (_PureComponent) {
  ...
  function MoreButton() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = MoreButton.__proto__ || (0, _getPrototypeOf2.default)(MoreButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (_ref2) {
      var v = _ref2.value;
