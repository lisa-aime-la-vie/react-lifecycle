...
var DatePicker = function (_PureComponent) {
  ...
  function DatePicker(props) {
    ...
    _this.componentWillReceiveProps = function (nextProps) {
      ...
      } else if (nextProps.defaultValue !== _this.props.defaultValue && _this.state.value === undefined) {
        _this.setState({
    ...
    _this.loseFocus = function () {
      ...
      var d = new Date(transformDate ? transformDate(_this.input.value) : _this.input.value);
    ...
    _this.render = function () {
      var _this$props = _this.props,
          ...
          id = _this$props.id,
          rest = (0, _objectWithoutProperties3.default)(_this$props, ['placeholder', 'className', 'style', 'name', 'showIcon', 'errored', 'disabled', 'monthNames', 'weekdayNames', 'shortWeekdayNames', 'id']);
