...
var DoB = function (_Component) {
  ...
  function DoB(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (DoB.__proto__ || (0, _getPrototypeOf2.default)(DoB)).call(this, props));
  ...
  this.handleChange = function (name) {
    return function (_ref2) {
      ...
      var newState = (0, _extends4.default)({}, _this3.state, {
        values: (0, _extends4.default)({}, _this3.state.values, (0, _defineProperty3.default)({}, name, parseInt(value, 10)))
      });
