    ...
    var Connect = function (_PureComponent) {
      ...
      function Connect(props, context) {
        ...
        _this.validate = function (value) {
          ...
          var _reduceReducers = _utils.reduceReducers.apply(undefined, (0, _toConsumableArray3.default)(chain))(new _validation.ValidationResult(name, parser(value, { l10n: l10n }), null)),
      ...
      (0, _createClass3.default)(Connect, [{
        ...
        value: function render() {
          ...
          this.renderedElement = (0, _react.createElement)(WrappedComponent, (0, _utils.omit)(wrappedComponentProps, omitArr));
