...
var Form = function (_PureComponent) {
  ...
  function Form(props, context) {
    ...
    _this.invokeValidators = function () {
      _this.store.tryInvokeValidators();
    };
  ...
  (0, _createClass3.default)(Form, [{
    ...
    key: 'initStore',
    value: function initStore(props) {
      ...
      if (this.parentStore) {
        this.parentStore.childStoreList = [].concat((0, _toConsumableArray3.default)(this.parentStore.childStoreList), [this.store]);
      }
    }
  }, {
    key: 'render',
...
Form.contextTypes = (0, _defineProperty3.default)({}, aauiFormStore, _propTypes2.default.instanceOf(_store2.default));
