...
var PasswordTextInput = function (_PureComponent) {
  ...
  function PasswordTextInput() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PasswordTextInput.__proto__ || (0, _getPrototypeOf2.default)(PasswordTextInput)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      type: 'password'
  ...
  (0, _createClass3.default)(PasswordTextInput, [{
    key: 'render',
