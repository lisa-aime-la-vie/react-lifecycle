...
var es_CL = exports.es_CL = {
   ...
   * @private
   *
   * Date/time formatting symbols for locale ca_ES (catalan).
   */
};var ca_ES = exports.ca_ES = {
  ERAS: ['aC', 'dC'],
  ...
  AMPMS: ['a. m.', 'p. m.'],
  DATEFORMATS: ["EEEE MMMM 'de' d 'de' y", "MMMM 'de' d 'de' y", 'MMM d y', 'M/d/yy'],
  TIMEFORMATS: ['h:mm:ss a zzzz', 'h:mm:ss a z', 'h:mm:ss a', 'h:mm a'],
  FIRSTDAYOFWEEK: 6,
  WEEKENDRANGE: [5, 6],
  FIRSTWEEKCUTOFFDAY: 5,
  ...
  FORMAT: {
    ...
    SHORT_DATE_WITHOUT_YEAR: 'M/d',
    MONTH_ABBR_DATE: 'MMM d yyyy',
    LONG_DATE: 'MMMM de d de yyyy',
    LONG_DATETIME: 'MMMM de d de yyyy HH:mm',
    LONG_DAYOFWEEK: 'EEEE MMMM de d de yyyy',
    TIME_INPUT: 'HH:mm'
  },
