...
var FIELD_PREFIX = 'addressForm.addressField'; // eslint-disable-line import/no-cycle
  ...
  function AddressEditor(props, context) {
    ...
    _this.reduceFields = function (country) {
      ...
      return (0, _keys2.default)(countryAddressFields).reduce(function (r, k) {
        ...
        return (0, _extends5.default)({}, r, (0, _defineProperty3.default)({}, addressPart, finalField));
      }, { country: country });
    };
    ...
    _this.handlePreChange = function (values) {
      ...
      return (0, _keys2.default)(countryAddressFields).reduce(function (r, k) {
        ...
        return (0, _extends5.default)({}, r, (0, _defineProperty3.default)({}, addressPart, (0, _extends5.default)({}, addressPartValue, {
  ...
  (0, _createClass3.default)(AddressEditor, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _props$isSimpleAddres = _props.isSimpleAddress,
          isSimpleAddress = _props$isSimpleAddres === undefined ? false : _props$isSimpleAddres,
          fieldsConfig = _props.fieldsConfig,
          addressEditorTitles = _props.addressEditorTitles,
          addressEditorIds = _props.addressEditorIds,
          rest = (0, _objectWithoutProperties3.default)(_props, ['fieldLayout', 'isSimpleAddress', 'fieldsConfig', 'addressEditorTitles', 'addressEditorIds']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(FieldLayout, (0, _extends5.default)({
            title: addressEditorTitles && addressEditorTitles.country,
            maxHeight: '320px',
            name: 'country',
          ...
          reducedCountryAddressFields.map(function (f) {
            if (isSimpleAddress && (f.name === 'line1' || f.name === 'line2' || f.name === 'line2.2' || f.name === 'city.2' || f.name === 'stateProvince.2' || f.name === 'postalCode')) {
              return null;
            }
            return _react2.default.createElement(FieldLayout, (0, _extends5.default)({
              id: addressEditorIds && addressEditorIds[f.name],
              title: addressEditorTitles && addressEditorTitles[f.name],
              key: f.name,
              name: f.name
            }, f, fieldsConfig[f.name] || {}));
          })
        )
      );
    }
...
AddressEditor.propTypes = (0, _extends5.default)({
  ...
  fieldsConfig: _propTypes.object, // eslint-disable-line

  fieldLayout: (0, _propTypes.oneOfType)([_propTypes.node, _propTypes.func]),
  addressEditorTitles: _propTypes.object,
  addressEditorIds: _propTypes.object
