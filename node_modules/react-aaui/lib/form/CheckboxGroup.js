...
var FormCheckboxGroup = function (_PureComponent) {
  ...
  function FormCheckboxGroup() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = FormCheckboxGroup.__proto__ || (0, _getPrototypeOf2.default)(FormCheckboxGroup)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (value) {
  ...
  (0, _createClass3.default)(FormCheckboxGroup, [{
    key: 'render',
