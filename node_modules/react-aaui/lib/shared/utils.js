...
var filterProps = exports.filterProps = function filterProps() {
  ...
  return whitelist.reduce(function (filtered, name) {
    ...
    if (Object.prototype.hasOwnProperty.call(props, name)) {
      ...
      return (0, _extends6.default)({}, filtered, (0, _defineProperty3.default)({}, name, propValue));
...
var filterValidProps = exports.filterValidProps = function filterValidProps(obj) {
  var re = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : /^((aria|data)-.+)|id$/;
  return obj && (0, _keys2.default)(obj).filter(function (key) {
    return re && re.test(key);
  }).reduce(function (res, key) {
    return (0, _extends6.default)({}, res, (0, _defineProperty3.default)({}, key, obj[key]));
  }, {});
};